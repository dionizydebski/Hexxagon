...
//public:
//    Button(const std::string &t, const sf::Vector2f &size, const sf::Color &bgColor,const sf::Font &font,const WINDOWSTATE &windowstateChange): text(font), windowstateChange(windowstateChange){
//        text.setString(t);
//        text.setFillColor(sf::Color::Black);
//        text.setFont(font);
//        text.setCharacterSize(20);
...
//        return fof;
//    }
//    bool isFriendOrFriendFriend(std::vector<std::vector<Hexagon>> &gameboard, STATE s){
//        for(auto i : this->Friends(gameboard))
//            if(i.state == s)
//                return true;
//        for(auto i : this->FriendsOfFriends(gameboard))
